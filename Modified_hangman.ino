...
if (v == 1)  {
    v = 1;
          ...
          lcd.clear();
          lcd.setCursor(1, 0);
          lcd.print("Show the word?");
          lcd.setCursor(1, 1);
          lcd.print(" Down=N / Up=Y");
  ...
  if (n == 10){
   ...
   // new word 
    ...
    if (pocet == 0) {
                                    lcd.setCursor(0, 0);
                                    lcd.print("nothing embedded");
                                    lcd.setCursor(0, 1);
                                    lcd.print("I choose floods!");
                                    buzz(ELOW, 250);                  
                                    buzz(CLOW, 500);                 
                                    delay(4000);
      ...
      lcd.clear();
      lcd.setCursor(0, 0);
      lcd.print("you have a word:");
      if (pocet == 0) {
                                     lcd.clear();
                                     lcd.setCursor(2, 0);
                                     lcd.print("New word is:");
                       }
      if (pocet > 0) {
                                     //lguessWord = newword;
                                     buzz(EHIGH, 50);
